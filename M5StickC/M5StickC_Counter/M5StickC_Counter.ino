/*
 * File: M5StickC_Counter.ino
 * 
 * Testprogram for Geiger-Müller-Zähler
 * based on makerGeiger.ino by Bernd Laquai https://github.com/opengeiger/makerGeiger
 * 
 * PiGl-Output is connected to G26 @ M5StickC. Do not used G36. There is no internal pull-up.
 * 
 * 2022-04-01 Claus Kühnel info@ckuehnel.ch
 */
