...
void readBME680()
{
  ...
  if (iaqSensor.run())   // If new data is available
  {
    ...
    output += ", " + String(Acc=iaqSensor.iaqAccuracy);
    output += ", " + String(temp=iaqSensor.temperature);
    output += ", " + String(hum=iaqSensor.humidity);
    output += ", " + String(iAQ=iaqSensor.staticIaq);
    output += ", " + String(eCO2=iaqSensor.co2Equivalent);
    output += ", " + String(bVOC=iaqSensor.breathVocEquivalent);
