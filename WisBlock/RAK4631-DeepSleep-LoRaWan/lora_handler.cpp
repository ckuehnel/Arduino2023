...
uint8_t nodeDeviceEUI[8] = {0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x04, 0xDF, 0x3B};
/** Application EUI required for network join */
uint8_t nodeAppEUI[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
/** Application key required for network join */
uint8_t nodeAppKey[16] = {0x4F, 0xE8, 0x34, 0x0C, 0x4A, 0x9B, 0x3F, 0x8C, 0x85, 0xD6, 0xCA, 0xE2, 0x07, 0x08, 0xA4, 0xE0};
...
bool sendLoRaFrame(void)
{
  ...
  shtc3_read_data();
	...
	uint8_t buffSize = 0;
	m_lora_app_data_buffer[buffSize++] = highByte(batteryVoltage);
	m_lora_app_data_buffer[buffSize++] = lowByte(batteryVoltage);
	m_lora_app_data_buffer[buffSize++] = batteryCharge;
	m_lora_app_data_buffer[buffSize++] = highByte(insideTemperature);
	m_lora_app_data_buffer[buffSize++] = lowByte(insideTemperature);
  m_lora_app_data_buffer[buffSize++] = insideHumidity;
