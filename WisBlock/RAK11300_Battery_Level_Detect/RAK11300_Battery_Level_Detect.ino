...
#define DEBUG 0            // set to 1 for more output
...
void setup()
{
  ...
  Serial.println("\nRAK11300 Battery test"); // Change this if you want
  Serial.println("Resolution of internal ADC 12 Bit");
  Serial.println("The mean value is formed by 10 individual values");
  Serial.println();
...
void loop()
{
    // Get a raw ADC reading (mean value)
   ...
   Serial.printf("LiPo mean voltage = %.3f V\n", vbat_mv/1000); 
   Serial.printf("LiPo mean  level  = %d %%\n\n", vbat_per);
   delay(5000);
}
