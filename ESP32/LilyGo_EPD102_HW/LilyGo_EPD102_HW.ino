/*
    LilyGo Ink Screen Series u8g2Fonts Test  - Created by Lewis he
    T-Dispay E-paper 1.02"
...
void setup(void)
{
    Serial.begin(115200);
    delay(2000);
    Serial.println("LILYGO T-Display ePaper 128x80");
...
void loop()
{
    ...
    display.setCursor(0, 10); display.println("Hello World");
    display.setCursor(0, 26); display.println("This is");
    display.setCursor(0, 42); display.println("ESP32 with");
    display.setCursor(0, 58); display.println("1.02 ePaper");
    display.setCursor(0, 74); display.println("128x80 dots");
    display.update();
    delay(10000);
}
